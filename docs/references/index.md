...
For using VoltScript Logging via VoltScript Build Manager extension in Visual Studio Code, follow the instruction on the [how-to guide](../howto/archipelago.md).

## API documentation

- [VoltScript Logging Class Documentation](./apidoc/index.html){: target="_new" rel="noopener noreferrer”}

## Unit test output

- [All tests](./testreports/index.html){: target="_new" rel="noopener noreferrer”}

## FAQs

List of [frequently asked questions](FAQs.md) related to VoltScript Logging.  
...
- VoltScript Volt MX Middleware
    ...
    - [Source code](https://github.com/HCL-TECH-SOFTWARE/voltscript-voltmx-middlewarer){: target="_blank" rel="noopener noreferrer"}
